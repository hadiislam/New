...
gg.clearResults()
gg.toast("𝙷𝙴𝙰𝙳𝙰𝙷𝙾𝚃 100% 𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴 ")
end
...
function STANDSCOPE()
  ...
  gg.clearResults()
  gg.toast("β πππ°π½π³ ππ²πΎπΏπ΄ π°π²ππΈππ°ππ΄π³")
end
...
function shake()
  ...
  gg.toast("β  π°π½ππΈ-ππ·π°πΊπ΄ π°π²ππΈππ°ππ΄π³.")
end
...
function Home()
local﻿ file = gg.makeRequest('https://raw.githubusercontent.com/hadiislam/New/main/HOME.lua')
